...
class Pyramic_Tic_Tac_Toe_Board:public Board {
public:
...
class PyramicRandomPlayer: public Player {
    ...
    public:
        // Take a symbol and pass it to parent
        PyramicRandomPlayer (char symbol, int dimension_x, int dimension_y);
        // Generate a random move
        void get_move(int& x, int& y);
};

class FourRandomPlayer: public Player {
    protected:
        int dimension_x;
        int dimension_y;
    public:
        // Take a symbol and pass it to parent
        FourRandomPlayer (char symbol, int dimension_x, int dimension_y);
        // Generate a random move
        void get_move(int& x, int& y);
};
